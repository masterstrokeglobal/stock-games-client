    ...
    const roundRecord = useMemo(() => {
        ...
        const rearrangeMarketsForWheel = (markets: any[]) => {
            ...
            const wheelToMarketMapping = [
                1,  // wheel index 0  -> market index 1 (green)
                0,  // wheel index 1  -> market index 0 (red)
                4,  // wheel index 2  -> market index 4 (green)
                3,  // wheel index 3  -> market index 3 (red)
                7,  // wheel index 4  -> market index 7 (green)
                5,  // wheel index 5  -> market index 5 (purple)
                6,  // wheel index 6  -> market index 6 (red)
                10, // wheel index 7  -> market index 10 (green)
                8,  // wheel index 8  -> market index 8 (blue)
                9,  // wheel index 9  -> market index 9 (red)
                13, // wheel index 10 -> market index 13 (green)
                11, // wheel index 11 -> market index 11 (purple)
                12, // wheel index 12 -> market index 12 (red)
                16, // wheel index 13 -> market index 16 (green)
                14, // wheel index 14 -> market index 14 (blue)
                15, // wheel index 15 -> market index 15 (red)
                20, // wheel index 16 -> market index 20 (gold)
                19, // wheel index 17 -> market index 19 (blue)
                18, // wheel index 18 -> market index 18 (red)
                17, // wheel index 19 -> market index 17 (purple)
                2   // wheel index 20 -> market index 2 (red, last one used)
            ];
