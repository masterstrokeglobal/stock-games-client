...
const SettingLayout: React.FC<SettingLayoutProps> = ({ children, className, parentClassName }) => {
    return (
        <div className={cn("relative sm:w-[calc(100%-4rem)] sm:pb-0 pb-10 sm:px-0 px-2 w-full mx-auto sm:min-h-[calc(100svh-7rem)]  h-full flex flex-col items-center justify-center bg-transparent", parentClassName)}>
            ...
            <img src="/images/seven-up-down/bull.png" alt="Bull" className="absolute z-[11] md:-bottom-24 -bottom-6 md:-left-1/4 -left-60 translate-x-1/2 w-auto md:h-80 h-64 xxl:h-96" />
            <img src="/images/seven-up-down/bear.png" alt="Bear" className="absolute z-[11] md:-bottom-12 -bottom-0   right-0 w-auto md:h-60 h-48 xxl:h-72" />
