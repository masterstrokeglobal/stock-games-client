                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-sm leading-relaxed">
                            <li className="flex items-start gap-3">
                                ...
                                <span>13 random stocks are selected from the market for each round</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-[#6DC1EE] font-bold">2.</span>
                                <span>Place your bets on 7UP, 7DOWN</span>
                            </li>
                            <li className="flex items-start gap-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-4 text-sm">
                            <div className="p-4 rounded-lg bg-[rgba(41,92,181,0.3)] border border-[#295CB5]">
                                ...
                                <div>7 or More than 7 stocks end positive</div>
                            </div>
                            <div className="p-4 rounded-lg bg-[rgba(41,92,181,0.3)] border border-[#295CB5]">
