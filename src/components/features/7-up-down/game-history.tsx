...
const GameHistoryTable = ({ className }: { className?: string }) => {
  ...
  const { data: allGameHistory } = useGetAllGameHistory({ roundRecordGameType: RoundRecordGameType.SEVEN_UP_DOWN, type: gameType, page: page, limit: 10, startDate: filterStartDate });
