...
export const layerConfigs: LayerConfig[] = [
  {
    ...
    speed: 0.5,
    altitudeRange: [0.7, 1.0], // Highest altitude - space objects (top 5% of sky)
    objects: [
      { src: "/images/aviator/objects/star1.png", scale: [0.3, 0.5], count: 70 },
      { src: "/images/aviator/objects/star2.png", scale: [0.3, 0.5], count: 70 },
      { src: "/images/aviator/objects/moon.png", scale: [0.4, 0.6], count: 52 },
      { src: "/images/aviator/objects/rocket.png", scale: [0.2, 0.3], count: 30 } // Rockets in space only
    ]
  },
  {
    ref: "translateContainerRef_0_7",
    speed: 0.7,
    altitudeRange: [0.7, 1], // Very high altitude - planets (upper space region)
    objects: [
  ...
  },
  {
    ...
    speed: 1.2,
    altitudeRange: [0.2, 0.85], // High clouds altitude (upper atmosphere)
    objects: [
      { src: "/images/aviator/objects/cloud-1.png", scale: [0.6, 0.8], count: 30 },
      { src: "/images/aviator/objects/cloud-2.png", scale: [0.6, 0.8], count: 30 },
      { src: "/images/aviator/objects/cloud-3.png", scale: [0.6, 0.8], count: 30 },
      { src: "/images/aviator/objects/cloud-4.png", scale: [0.7, 0.9], count: 30 },
      { src: "/images/aviator/objects/cloud-5.png", scale: [0.7, 0.9], count: 30 },
      { src: "/images/aviator/objects/cloud-6.png", scale: [0.7, 0.9], count: 30 }
    ]
  },
  {
    ref: "translateContainerRef_1_3",
    speed: 1.5,
    altitudeRange: [0.05, 0.75], // Medium-high clouds altitude (commercial flight level)
    objects: [
      { src: "/images/aviator/objects/cloud-1.png", scale: [0.6, 0.8], count: 30 },
      { src: "/images/aviator/objects/cloud-2.png", scale: [0.6, 0.8], count: 30 },
      { src: "/images/aviator/objects/cloud-3.png", scale: [0.6, 0.8], count: 30 },
...
export const generateLayerObjects = (layer: LayerConfig) => {
  ...
  const totalHeight = 8000 // Total parallax height
  ...
  if (maxY <= minY) {
    console.warn(`Invalid range for layer ${layer.ref}: minY=${minY}, maxY=${maxY}`)
    return allObjects
  }
