...
function OtherPlanes({
  ...
  return (
    <div className="flex mt-4 flex-col gap-2">
      <div className="text-white text-sm font-medium mb-2">NEXT IN LINE</div>
      <div className="flex flex-col gap-2 max-h-64 overflow-hidden scrollbar-hide">
          ...
          return (
            <div
              ...
              className={`
                ...
                w-[250px] min-h-[80px] flex justify-between
