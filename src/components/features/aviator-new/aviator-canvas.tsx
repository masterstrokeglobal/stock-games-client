...
const AviatorCanvas = ({
  ...
  useEffect(() => {
    ...
    const initialPosition = new THREE.Vector3(0, -3, -4); // Far away, bottom left
  ...
  useEffect(() => {
    ...
    if (shouldStartTakeOffAnimation) {
      ...
      const takeOffAction = sceneRef.current.actions.find(
        (action) =>
      ...
      if (takeOffAction) {
        ...
        console.log(
          "⚠️ Take 001 animation not found. Available animations:",
