...
const Navbar = ({ className }: Props) => {
  ...
  return (
    <nav
      className={cn(
        "items-center md:px-6 sm:px-4 px-2 z-50 border-b border-platform-border bg-primary-game flex fixed top-0 justify-between font-semibold w-full h-14  mb-4",
        className
      )}
    >
        ...
        {!isLoggedIn && (
          <div className="flex items-center space-x-4">
            ...
            <Link href="/game/auth/register">
              <Button className="active-menu-button  rounded-full">
                {t("signup")}
              </Button>
            </Link>
          </div>
