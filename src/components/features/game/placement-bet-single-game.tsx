...
const PlacementBetsSingleGame = ({ className, roundRecord }: Props) => {
                            ...
                            {currentBetsData.map((bet, index: number) => (
                                ...
                                >
                                    ...
                                    <td className="p-2 text-sm text-right text-gray-300 rounded-r-lg flex-1">
                                        {bet.marketItem?.id ? roundRecord?.getMarketNumberById(bet.marketItem.id) : "-"}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
...
export default PlacementBetsSingleGame;
