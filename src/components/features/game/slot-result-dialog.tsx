          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="text-center  flex justify-between  rounded-lg">
                ...
                <p className="text-xl ">₹{data.totalPlaced}</p>
              </div>

              <div className="text-center  flex justify-between  rounded-lg">
                <p className="">Total Winnings</p>
                <p className="text-xl ">₹{data.grossWinning}</p>
              </div>

              <div className="text-center  flex justify-between  rounded-lg">
                <p className="">Platform Fees</p>
                <p className="text-xl ">- ₹{data.platformFeeAmount}</p>
              </div>

              <div className="text-center  flex justify-between  rounded-lg">
                <p className="">Net Winning</p>
                <p className="text-xl ">₹{data.netWinning}</p>
              </div>
