            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                <img
                  ...
                  alt="plane"
                  className={`w-auto h-6  ${canSwitch ? '' : 'grayscale'}`}
                />
                <div className="min-w-0 flex-1">
                  <div className={`text-xs font-semibold truncate ${canSwitch ? 'text-white' : 'text-gray-300'
                    }`}>
                    {stock.name}
                  </div>
                  <div className={`text-xs truncate ${canSwitch ? 'text-blue-100' : 'text-gray-400'
                    }`}>
                    {codeToCheck}
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className={`text-sm font-bold ${canSwitch ? 'text-green-300' : 'text-gray-400'
                  }`}>
                  {multiplier.toFixed(2)}x
                </div>
                <div className="flex flex-col items-end gap-1">
                  <div className={`text-xs px-2 py-1 rounded-full border ${status === "active" ? 'bg-green-500/30 text-green-200 border-green-400/50' :
