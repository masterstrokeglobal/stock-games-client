        ...
        >
          ...
          <DialogDescription className="text-center text-white mb-5 p-2 flex flex-col gap-2 w-full overflow-y-auto max-h-[40vh] min-h-[200px] text-xs lg:text-base xl:text-2xl">
            <div className="w-full  rounded-lg overflow-hidden">
              <video src={videoUrl} controls className="w-full h-96 rounded-xl" />
              <div className="flex justify-center w-full py-4">
                <button
                  className={`px-4 py-1 rounded-l-lg text-sm  flex-1 transition-colors ${lang === "en"
                ...
                <button
                  className={`px-4 py-1 rounded-r-lg text-sm  flex-1 transition-colors ${lang === "hi"
                    ? "bg-white/20 text-white"
