...
const navItems = [
    ...
    { icon: IconLayoutGrid, label: "Table Games", href: `/game/platform/casino/${GameCategory["Table game"]}` ,authorized: false},
    { icon: IconVideo, label: "Live Casino", href: `/game/platform/casino/${GameCategory["Live Dealer"]}` ,authorized: false},
