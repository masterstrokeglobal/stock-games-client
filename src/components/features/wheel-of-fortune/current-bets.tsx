...
const CurrentBets = ({ roundRecord, className, tableClassName }: { roundRecord: RoundRecord, className?: string, tableClassName?: string }) => {
    ...
    return (
        <section style={{
            ...
            <header className="text-white uppercase md:text-2xl text-xl  space-y-2  relative   py-3 px-4 font-medium">
                Your Bets
                <div style={{
                    background: 'linear-gradient(90deg, #5D8B86 0%, #1E3D11 100%)',
                }} className="w-[calc(100%-2rem)] h-px z-[11]  absolute bottom-0 left-1/2 -translate-x-1/2" />
            </header>
