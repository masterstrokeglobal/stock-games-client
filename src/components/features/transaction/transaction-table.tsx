  ...
  const handleDownloadCsv = () => {
    try {
      ...
      const body = rows.map((item: any) => {
        const isPoints =
          item?.type === "points_earned" || item?.type === "points_redeemed";
        const amount = isPoints
  ...
  return (
    <section className={cn("container-main min-h-[60vh] my-12", className)}>
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value={TransactionType.PLACEMENT}>
                  Placement
                </SelectItem>
                ...
                <SelectItem value={TransactionType.POINTS_EARNED}>
                  Points Earned
                </SelectItem>
                <SelectItem value={TransactionType.POINTS_REDEEMED}>
                  Points Redeemed
                </SelectItem>
              </SelectGroup>
            </SelectContent>
      ...
      <div className="flex gap-4 justify-end mt-3">
        ...
        <Button onClick={handleDownloadCsv}>Download Excel</Button>
      </div>
      <main className="mt-4">
        <DataTable
          page={page}
