            ...
            <div className="w-full flex relative z-10 flex-col md:flex-row items-center justify-center bg-transparent px-2 ">
                ...
                <div className="flex gap-2 items-center flex-wrap">
                    ...
                    <div className="flex-1 flex justify-center" style={{
                        ...
                        <div
                            className="flex w-full  md:flex-col relative gap-x-2  items-center justify-center rounded-[30px] md:px-6 px-2 py-2 min-w-[120px] md:h-16"
                            style={{
                        ...
                        >
                            ...
                            <span className="text-white text-xl font-semibold text-nowrap font-phudu tracking-wide">₹ {totalBet}</span>
                        </div>
                    </div>
                </div>
            </div>
