            ...
            <Tabs className="flex-1  mt-8  pt-6 w-full" value={tab} onValueChange={(value) => setTab(value as SchedulerType)}>
                ...
                <div className="w-full">
                    <div className="grid relative grid-cols-1  gap-6  rounded-lg  pt-20  ">
                        <img src="https://res.cloudinary.com/dt8iv1hds/image/upload/v1758190959/background_udodvw.jpg" alt="four-group-bg" className=" w-full absolute top-0 left-0 object-cover  mx-auto  h-full " />
                        ...
                        <div className="relative h-full w-full md:min-h-[700px]  sm:min-h-[600px] min-h-[400px]  bg-contain bg-no-repeat bg-center">
                            <div className="absolute bottom-0 w-full h-fit ">
                                ...
                                <img src="https://res.cloudinary.com/dt8iv1hds/image/upload/v1758190961/table_c7pyen.png" alt="four-group-table" className=" w-full sm:mx-auto   h-full  relative z-10  md:max-w-5xl sm:max-w-2xl max-w-xl" />
