...
const WheelOfFortune = () => {
  ...
  if (isMobile) {
    return (
      <section className="flex flex-col relative space-y-2 overflow-hidden bg-gradient-to-b from-[#1a1b2e] to-[#1a1b2e]/0 items-center justify-start pt-[56px] min-h-screen w-full">
        <Navbar />
        <video
          playsInline
          webkit-playsinline="true"
          src="/videos/wheel-of-fortune.mp4"
          autoPlay
          muted
          loop
        ...
        <div
          style={{
            transform: isPlaceOver
              ? "translateY(-30px)"
              : `translateY(-${wheelHeight}px)`,
  ...
  return (
    <section className="flex flex-col relative bg-gradient-to-b from-[#1a1b2e] to-[#1a1b2e]/0  items-center justify-center min-h-[calc(100svh-100px)] w-full">
      ...
      <div className="min-h-screen pt-[72px]  px-4 max-w-[1560px] w-full mx-auto  text-white ">
