...
import StockCardStack from "@/components/features/four-group/stock-card";
    ...
    return (
        <div className="flex flex-col min-h-screen  relative from-green-800 via-green-900 to-green-950 bg-repeat bg-center text-white  mx-auto">
            ...
            <Tabs className="flex-1  mt-8  pt-6 w-full" value={tab} onValueChange={(value) => setTab(value as SchedulerType)}>
                    ...
                    <div className="grid relative grid-cols-1  gap-6  rounded-lg  pt-20  ">
                        ...
                        <div className="relative h-full w-full md:min-h-[700px]  sm:min-h-[600px] min-h-[400px]  bg-contain bg-no-repeat bg-center">
                            <div className="absolute bottom-0 w-full h-fit ">
                                ...
                                {roundRecord && <StockCardStack className="absolute p-2 left-1/2 -translate-x-1/2 md:bottom-[calc(30%+1rem)] bottom-[calc(10%+1rem)]" roundRecord={roundRecord} />}
                                <img src="/images/four-group/table.png" className=" w-full sm:mx-auto   h-full  relative z-10  md:max-w-6xl sm:max-w-2xl max-w-xl" />
                            </div>
                        </div>
                        <BettingChips
                            showBetting={true}
                ...
                {roundRecord && <SinglePlayerRouletteGame roundRecord={roundRecord} globalBetAmount={globalBetAmount} >
