...
const ContactPage = () => {
    ...
    return (
        <div className="flex flex-col items-center max-w-3xl mx-auto dark:bg-[#050128] bg-transparent rounded-t-3xl rounded-b px-4 sm:px-6 py-6 sm:py-8 gap-6 sm:gap-8">
            {/* Call Us Now Card */}
