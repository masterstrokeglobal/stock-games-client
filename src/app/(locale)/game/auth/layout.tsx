...
const AuthLayout: React.FC = ({ children }: PropsWithChildren) => {
    ...
    return (
        <div className="min-h-screen overflow-hidden flex text-game-text justify-center pt-20 items-center h-screen bg-background-secondary">
            ...
            <section className="md:bg-primary-game shadow-2xl shadow-game-secondary rounded-2xl max-w-6xl w-full md:shadow-lg md:border border-primary-game  flex flex-col md:flex-row h-full md:h-[80svh]">
